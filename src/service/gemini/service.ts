...
export async function generateFromImage(file: File) {
    try {
        ...
        const result = await model.generateContent([
            ...
            `
      Hãy phân tích hình ảnh được tải lên để xác định các món ăn hoặc thực phẩm chế biến (đồ ăn được) xuất hiện. Sau đó, hãy cung cấp thông tin chi tiết theo định dạng sau:
      ...
      **2. [Tên món ăn 1]**
      ...
      Hãy cung cấp thông tin chi tiết và rõ ràng theo đúng định dạng trên. Với mỗi món ăn hoặc thực phẩm chế biến (đồ ăn được) sẽ là một section, section bắt đầu với **[Tên món ăn]**, mỗi ý sẽ bắt đầu với dấu "-".
      Nếu hình ảnh không có bất kỳ món ăn hoặc thực phẩm chế biến (đồ ăn được) nào, hãy trả về đoạn text ngắn gọn nhất trong đó có từ "không hợp lệ"
      `.trim(),
        ]);
