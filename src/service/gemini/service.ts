  ...
  try {
    ...
    const result = await model.generateContent([
      ...
      **2. [Tên món ăn 1]**
      ...
      Hãy cung cấp thông tin chi tiết và rõ ràng theo đúng định dạng trên. Với mỗi món ăn sẽ là một section, section bắt đầu với **[Tên món ăn]**, mỗi ý sẽ bắt đầu với dấu "-".
