...
import {NutritionInfo, Section} from './NutritionInfo';
...
export function CollectData() {
    ...
    const {mutate, isPending} = useMutation({
        mutationFn: async (data: CollectDataForm) => {
            ...
            if ('chatSession' in ai) {
                return await handleUserInput({dataForm: data, userInput: prompt, chatSession: ai.chatSession});
    ...
    const renderStep = () => {
        if (response) {
            return <NutritionInfo data={response}/>;
        }
