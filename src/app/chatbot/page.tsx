...
export default function Home() {
  ...
  useEffect(() => {
    const initChat = async () => {
      ...
      if (result.success) {
        ...
        setMessages([
          { sender: 'bot', text: 'Chatbot initialized. How can I help you?' },
        ]);
      } else {
        ...
        setMessages([
          {
            sender: 'bot',
            text: `Error initializing chatbot: ${result.error}`,
          },
        ]);
      }
    };
  ...
  const sendMessage = async () => {
    ...
    if (response.success) {
      ...
      setMessages((prev) => [
        ...prev,
        { sender: 'bot', text: `Error: ${response.error}` },
      ]);
    }
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-between p-8 sm:p-20 font-sans">
      ...
      <main className="flex flex-col items-center w-full max-w-2xl">
        {error ? (
          ...
          <>
            <div className="chat-window border border-gray-300 rounded-lg p-4 bg-gray-50 dark:bg-gray-800 w-full h-96 overflow-y-auto">
            ...
            <div className="chat-input flex gap-2 mt-4 w-full">
              <input
                ...
                placeholder={
                  isInitialized ? 'Type your message...' : 'Initializing...'
                }
                value={input}
